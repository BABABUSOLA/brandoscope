...
<html lang="en">
    ...
    <head>
       <title>Brandoscope</title>
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta content="width=device-width, initial-scale=1" name="viewport" />
        <meta content="Brandoscope offers brands quick, efficient and cost-effective means to track their own activities, competitor as well as industry activities via a tidy digital window to aggregated content sourced from print publications, and presents the information using beautiful infographics. Beyond these, Brandoscope offers perspective and insights crucial to smart decision making."
            name="description" />
    ...
    <div class="page-wrapper">
            ...
            <div class="page-header navbar navbar-fixed-top">
                ...
                <div class="page-header-inner ">
                    <!-- BEGIN LOGO -->
                     ...
                     <div class=" page-logo font-blue-steel " style="font-size:30px;">
                            <strong>BRANDOSCOPE</strong>
                           <!-- if the author registers under a compnay, replace bandoscope with the company name -->
                    ...
                    <div class="top-menu">
                        <ul class="nav navbar-nav pull-right">
                            ...
                            <!-- DOC: Apply "dropdown-dark" class after "dropdown-extended" to change the dropdown style -->
            ...
            <!-- END HEADER -->
            <!-- begin content and header divider -->
            <div class="clearfix">

            </div>
            <!-- end content and header divider -->
            <!-- end header -->